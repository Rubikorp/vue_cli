  ...
  <footer class="footer center">
    <div class="footer__left">
      ...
      <ul class="pages">
        ...
        <li class="pages__item" v-for="link in linkArr" :key="link.id">
          <router-link :to="link.url" class="pages__link">{{
            link.name
          }}</router-link>
        </li>
      </ul>
    ...
    <div class="footer__right">
      <div class="contacts">
        <h4 class="contacts__head">Contact</h4>
        <address class="contacts__address">
          55 East Birchwood Ave. Brooklyn, New York 11201
        </address>
        <a href="mailto:contact@interno.com" class="contacts__email"
          >contact@interno.com</a
        >
        <a href="tel:(123) 456 - 7890" class="contacts__tel"
          >(123) 456 - 7890</a
        >
      </div>
    </div>
